...
- (void)viewDidLoad {
    ...
    label.font = [UIFont fontWithName:@"HiraginoSansGB-W3" size:13];
    ...
    textField.text = [NSString stringWithFormat:@"您好！我是来自长圣的%@",[CSUserInfo shareInstance].info.nickname];
    textField.font = [UIFont fontWithName:@"HiraginoSansGB-W3" size:15];
