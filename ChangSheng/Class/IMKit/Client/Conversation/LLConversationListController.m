...
//        if ([cell.conversationModel.chatid isEqualToString:conversationModel.conversationId]) {
...
//}
////与上一个相同
////- (void)refreshTableRowWithConversationModel:(CSIMConversationModel *)conversationModel {
////    for (LLConversationListCell *cell in self.tableView.visibleCells) {
////        if ([cell.conversationModel.chatid isEqualToString:conversationModel.chatid]) {
////            cell.conversationModel = conversationModel;
////            break;
////        }
////    }
...
//    for (LLConversationListCell *cell in self.tableView.visibleCells) {
//        if ([cell.conversationModel.chatid isEqualToString:conversationId]) {
